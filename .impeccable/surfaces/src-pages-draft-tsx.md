...
Participants drafting castaways in turn; the creator starts the draft and promotes it into a competition. Action: draft a castaway on your turn; submit prop bets; create the competition. Constraints: realtime state is authoritative; there is no pick timer; pick order snakes (reverses every round); motion belongs to state transitions, not snapshot refreshes.
