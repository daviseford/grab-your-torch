...
export const BASE_PLAYER_SCORING: CategorizedPlayerScoring[] = [
  ...
  // --- Milestones ---
  {
    action: "eliminated",
    description:
      "1 point awarded per episode number (e.g. 6 points for Episode 6 elimination). In a multi-elimination episode, later eliminations get +0.5 each (e.g. 6.5 for the second boot). In the finale, runners-up at final tribal council count as the last eliminations.",
    category: "Milestones",
  },
  {
    action: "make_merge",
