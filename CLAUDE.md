...
- **Social login:** Google sign-in is native; Discord runs through an Identity Platform OIDC provider gated by `VITE_AUTH_DISCORD_PROVIDER_ID`. Console setup lives in `docs/social-login-setup.md`.
